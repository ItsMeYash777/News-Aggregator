...
function CountryNews() {
  ...
  const getCountryInfo = (iso) => {
    return countries.find(country => country.iso_2_alpha === iso?.toLowerCase()) || 
           { countryName: 'Unknown Country', png: null };
  };

  const countryInfo = getCountryInfo(params.iso);
          ...
          {!isLoading ? (
            data.length > 0 ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-text-secondary-light dark:text-text-secondary-dark">
                  No news articles found for {countryInfo.countryName} at this time. Please check back later.
                </p>
              </div>
            )
          ) : (
            <div className="flex justify-center items-center py-20">
              <div className="text-center">
                ...
                <p className="text-text-secondary-light dark:text-text-secondary-dark">Loading {countryInfo.countryName} news...</p>
              </div>
            </div>
          )}
        </div>
